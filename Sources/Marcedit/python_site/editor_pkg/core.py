...
# Extracted to text_normalize.py (Candidate E). Re-imported here so existing
# core.normalize_* / core.*_ligatures references and tests keep working.
# ============================================================================
from .text_normalize import (
    normalize_unicode,
    strip_invisible_chars,
    LIGATURE_MAP,
    LIGATURE_REVERSE_MAP,
    detect_ligatures,
    decompose_ligatures,
    restore_ligatures,
    normalize_text_for_matching,
    normalize_text_for_replacement,
...
# _robust_search lifted into searcher.py (Candidate C). Imported under the
# original private name so the in-module call sites stay unchanged.
from .searcher import find as _robust_search
